...
var Config = module.exports = function(opts) {
	...
	if (config === undefined) {
		...
		config.standardPicklistMapping = {
			...
			// 'IdeaTheme.Categories': 'IdeaCategory', // Can't retrieve non-customizable CustomObject named: IdeaCategory
			...
			// 'Question.Origin': 'QuestionOrigin', // Can't retrieve non-customizable CustomObject named: QuestionOrigin
